  ...
  if(summary.length===0){
    ...
    summary.forEach(s=>{
      ...
      if(stageEarlyWarning(s.stageMedias)){
        ...
        const warnLines = doc.splitTextToSize("⚠ Postura/adultos presentes — mesmo sem atingir o NC hoje, é sinal de pressão para os próximos dias. Reavaliar em breve.", pageW-margin*2);
